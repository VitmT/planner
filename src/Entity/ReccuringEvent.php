...
#[ORM\Entity(repositoryClass: ReccuringEventRepository::class)]
class ReccuringEvent
{
    ...
    private ?\DateTimeInterface $defaultTimestamp = null;
    #[ORM\Column(length: 255)]
    private ?string $reccurenceType = null;
    #[ORM\ManyToMany(targetEntity: User::class, mappedBy: 'events')]
    private Collection $users;
    #[ORM\OneToMany(mappedBy: 'reccuringEvent', targetEntity: ReccuringEventOccurence::class)]
    private Collection $reccuringEventOccurences;
