 ...
 */
final class Version20230519080118 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reccuring_event_occurence (id INT AUTO_INCREMENT NOT NULL, reccuring_event_id INT DEFAULT NULL, timestamp DATETIME NOT NULL, duration INT NOT NULL, INDEX IDX_DB1369DCE61EC4E7 (reccuring_event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
